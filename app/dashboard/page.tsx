  ...
  return (
    <div className="bg-[#E5E8EF] -mt-16 pt-16 pb-10 min-h-screen">
      <div className="max-w-[1400px] mx-auto px-3 sm:px-6 pt-4">
        {/* ── Dark shell ── */}
        <section className="bg-[#0B0F1C] rounded-[2rem] px-5 sm:px-8 pt-5 pb-7">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-6 text-[15px] font-medium text-white/70">
                <span className="text-white font-semibold">Find job</span>
                <Link
                  href="/companies"
                ...
                <button
                  ...
                  className={`hover:text-white transition-colors ${savedOnly ? "text-white font-semibold" : ""}`}
                >
            ...
            <div className="flex items-center gap-2.5">
              <span className="hidden sm:inline-flex items-center gap-1.5 text-white/80 text-sm">
                <svg
                  className="w-4 h-4"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                {user?.profile.city || "India"}
              </span>
              <Link
                href="/profile"
                className="w-10 h-10 rounded-full overflow-hidden bg-blue-600 text-white font-bold flex items-center justify-center"
              ...
              <Link
                href="/profile"
                className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/80 hover:text-white hover:border-white/30 transition-all"
                aria-label="Settings"
              >
                <svg
                  className="w-5 h-5"
              ...
              <button
                onClick={() =>
                  toast("Job alerts are coming soon", { icon: "🔔" })
                }
                className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/80 hover:text-white hover:border-white/30 transition-all"
